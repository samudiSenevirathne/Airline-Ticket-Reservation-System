...
public class FlightDetailWithTransferGoSideForm3Controller {
    ...
    public  static ArrayList<FlightDetail>getTransfer3GoSideRecords(){
        return getRecords;
    }

    public  static void setTransfer3GoSideRecords(){
        getRecords=new ArrayList();
    }

    public static void setTransfer3GoSideRecordsWithPara(ArrayList<FlightDetail>getRecords){
        FlightDetailWithTransferGoSideForm3Controller.getRecords =getRecords;
    }
