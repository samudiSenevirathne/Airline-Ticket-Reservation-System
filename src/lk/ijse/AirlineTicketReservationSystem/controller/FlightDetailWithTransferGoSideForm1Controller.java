...
public class FlightDetailWithTransferGoSideForm1Controller {
    ...
    public static ArrayList<FlightDetail> getTransfer1GoSideRecords(){
        return getRecords;
    }

    public static void setTransfer1GoSideRecords(){
        getRecords=new ArrayList();
    }

    public static void setTransfer1GoSideRecordsWithPara(ArrayList<FlightDetail>getRecords){
        FlightDetailWithTransferGoSideForm1Controller.getRecords =getRecords;
    }
